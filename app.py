...
st.markdown("""
Данное приложение позволяет предсказать **ВВП на душу населения в США**  используя модель машинного обучения.

Модель использует экономические индикаторы такие как:

- уровень безработицы (unemployment rate)
- инфляция (inflation)
- ставки по ипотеке (mortgage rates)
- индекс покупательской уверенности (consumer confidence)
- доход домохозяйств (household income)

Введите индикаторы ниже и нажмите **Predict**.
""")
